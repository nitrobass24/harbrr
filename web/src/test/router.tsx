...
// hosts the component under test; "/settings" and "/indexers" are plain targets some
// links point at;
...
export function withMemoryRouter(ui: ReactNode) {
  ...
  const indexersRoute = createRoute({ getParentRoute: () => rootRoute, path: "/indexers", component: () => null })
  ...
  const router = createRouter({
    routeTree: rootRoute.addChildren([indexRoute, settingsRoute, indexersRoute, applicationsRoute, downloadClientsRoute]),
